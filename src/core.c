...
{
    if (map->ships[ship_id].flag_ship_idx >= 0 && map->ships[ship_id].flag_ship_idx != ship_id)
    {
    ...
    {
        if (map->ships[i].flag_ship_idx == ship_id)
            map->ships[i].flag_ship_idx *= -1;
    }
}
